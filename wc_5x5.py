...
for i in reg:
    ...
    for mm in month:
        print('ncks'
              ...
              + ' wc2_30s_prec_' + mm + '.nc -o ~/hard/mksrf/wc_5x5/RG_'
              + str(int(i[0])) + '_' + str(int(i[1])) + '_' + str(int(i[2])) + '_' + str(int(i[3]))
              + '.PREC'+mm+'.nc')
        print('ncks'
              + ' -d lat,' + str(int(i[2])) + '.,' + str(int(i[0])) + '.'
              + ' -d lon,' + str(int(i[1])) + '.,' + str(int(i[3])) + '.'
              + ' wc2_30s_tavg_' + mm + '.nc -o ~/hard/mksrf/wc_5x5/RG_'
              + str(int(i[0])) + '_' + str(int(i[1])) + '_' + str(int(i[2])) + '_' + str(int(i[3]))
              + '.TAVG'+mm+'.nc')
        print('ncks'
              + ' -d lat,' + str(int(i[2])) + '.,' + str(int(i[0])) + '.'
              + ' -d lon,' + str(int(i[1])) + '.,' + str(int(i[3])) + '.'
              + ' wc2_30s_tmax_' + mm + '.nc -o ~/hard/mksrf/wc_5x5/RG_'
              + str(int(i[0])) + '_' + str(int(i[1])) + '_' + str(int(i[2])) + '_' + str(int(i[3]))
              + '.TMAX'+mm+'.nc')
        print('ncks'
              + ' -d lat,' + str(int(i[2])) + '.,' + str(int(i[0])) + '.'
              + ' -d lon,' + str(int(i[1])) + '.,' + str(int(i[3])) + '.'
              + ' wc2_30s_tmin_' + mm + '.nc -o ~/hard/mksrf/wc_5x5/RG_'
              + str(int(i[0])) + '_' + str(int(i[1])) + '_' + str(int(i[2])) + '_' + str(int(i[3]))
              + '.TMIN'+mm+'.nc')
        os.system('ncks'
              + ' -d lat,' + str(int(i[2])) + '.,' + str(int(i[0])) + '.'
